...
hi NamespaceTag             guifg=#f6f080   guibg=NONE      guisp=NONE      gui=italic    ctermfg=228     ctermbg=NONE    cterm=NONE
hi ClassTag                 guifg=#f6f080   guibg=NONE      guisp=NONE      gui=bold      ctermfg=228     ctermbg=NONE    cterm=NONE
hi StructureTag             guifg=#f6f080   guibg=NONE      guisp=NONE      gui=bold      ctermfg=228     ctermbg=NONE    cterm=NONE
hi EnumTag                  guifg=#f6f080   guibg=NONE      guisp=NONE      gui=bold      ctermfg=228     ctermbg=NONE    cterm=NONE
hi EnumValueTag             guifg=#b8d977   guibg=NONE      guisp=NONE      gui=italic    ctermfg=150     ctermbg=NONE    cterm=NONE
hi UnionTag                 guifg=#f6f080   guibg=NONE      guisp=NONE      gui=bold      ctermfg=228     ctermbg=NONE    cterm=NONE
hi MemberTag                guifg=#8aC8DB   guibg=NONE      guisp=NONE      gui=italic    ctermfg=110     ctermbg=NONE    cterm=NONE
hi LocalVariableTag         guifg=#8aC8DB   guibg=NONE      guisp=NONE      gui=NONE      ctermfg=110     ctermbg=NONE    cterm=NONE
hi VariableDefinitionTag    guifg=#8aC8DB   guibg=NONE      guisp=NONE      gui=NONE      ctermfg=110     ctermbg=NONE    cterm=NONE
hi FunctionPrototypeTag     guifg=#f6f080   guibg=NONE      guisp=NONE      gui=bold      ctermfg=228     ctermbg=NONE    cterm=NONE
hi FunctionDefinitionTag    guifg=#f6f080   guibg=NONE      guisp=NONE      gui=bold      ctermfg=228     ctermbg=NONE    cterm=NONE
hi MacroTag                 guifg=#fa9a4b   guibg=NONE      guisp=NONE      gui=NONE      ctermfg=215     ctermbg=NONE    cterm=NONE
hi TypedefTag               guifg=#72aaca   guibg=NONE      guisp=NONE      gui=NONE      ctermfg=110     ctermbg=NONE    cterm=NONE
hi ExternFwdDeclarationTag  guifg=#8aC8DB   guibg=NONE      guisp=NONE      gui=NONE      ctermfg=110     ctermbg=NONE    cterm=NONE
...
hi StorageClass             guifg=#f6f080   guibg=NONE      guisp=NONE      gui=italic    ctermfg=228     ctermbg=NONE    cterm=NONE
